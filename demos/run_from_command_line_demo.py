...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_output_dir output', default=None, type=int)

    args = parser.parse_args()

    clmaster= ['run_oceantracker.py',' --param_file *dir*\\demo01_plot_tracks.*ext*', ' --input_dir demo_hindcast', ' --root_output_dir *root_output*', ' --duration 36000.']
