...
import numpy as np
from oceantracker.particle_properties._base_particle_properties import ParticleProperty as __ParticleProperty

def set_values(part_prop: __ParticleProperty, values, select: np.ndarray):
...
def get_values(part_prop : __ParticleProperty, sel:'np.array(np.int32)'):
