...
class Online_eDNA(OTreRunner.OceanTrackerReRunner):
    ...
    def rerun(self,front_end_params= None, emit_method = OTreRunner.emit_to_print):
        ...
        self.for_test_plot = {'count': count,'conc': conc, 'heat_map_grid': s.grid,
                              'model_grid': si.core_class_roles.interpolator.grid,
                              }
...
if __name__ == '__main__':
    ...
    for regionID in [0]:
        ...
        print('Rerun time', perf_counter() - t0,'particles=', engine.otsim.shared_info.core_class_roles.particle_group_manager.info['num_released'])
