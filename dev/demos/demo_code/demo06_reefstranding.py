...
params = json_util.read_JSON("F:\H_Local_drive\ParticleTracking\oceantracker\dev\demos\build_and_test_demos.py\demo_param_files\demo06_reefstranding.json")
...
plot_tracks.animate_particles(track_data, axis_lims=[1591000, 1601500, 5478500, 5491000],
