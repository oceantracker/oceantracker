...
from oceantracker.post_processing.plotting import plot_tracks, plot_vertical_tracks, plot_statistics
from os import path
import argparse
...
if __name__ == '__main__':
    ...
    case ={'run_params':{
        ...
        'release_groups': [ {'points': x0 ,'pulse_size':10, 'release_interval': 600}],
