...
**Inheritance:** BaseReader> GenericUnstructuredReader> SCHSIMreaderNCDF
...
field_variables: still working on display  of nested  params dict <class 'dict'>
	...
	* ``field_variables_to_depth_average``:  *<optional>*
		...
		- self: ``<oceantracker.util.parameter_checking.ParameterListChecker object at 0x000002798A57B3A0>``
