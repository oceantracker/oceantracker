...
************
	...
	* ``grid_size``:  *<optional>*
		...
		- default list item: ``None``
		- self: ``<oceantracker.util.parameter_checking.ParameterListChecker object at 0x000001E0125A4820>``
		- can_be_empty_list: ``True``
		- fixed_len: ``2``
	...
	* ``grid_span``:  *<optional>*
		- a list containing type:  ``<class 'float'>``
		- default list item: ``None``
		- self: ``<oceantracker.util.parameter_checking.ParameterListChecker object at 0x000001E0125A4910>``
		- can_be_empty_list: ``True``
		- fixed_len: ``2``
