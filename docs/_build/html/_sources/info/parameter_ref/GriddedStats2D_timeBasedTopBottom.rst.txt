...
************
	...
	* ``grid_center``:  *<optional>*
		...
		- self: ``<oceantracker.util.parameter_checking.ParameterListChecker object at 0x0000029B1D014250>``
	...
	* ``grid_size``:  *<optional>*
		...
		- default list item: ``None``
		- self: ``<oceantracker.util.parameter_checking.ParameterListChecker object at 0x0000029B1CFE61C0>``
		- can_be_empty_list: ``True``
		- fixed_len: ``2``
	...
	* ``grid_span``:  *<optional>*
		- a list containing type:  ``<class 'float'>``
		- default list item: ``None``
		- self: ``<oceantracker.util.parameter_checking.ParameterListChecker object at 0x0000029B1D014280>``
		- can_be_empty_list: ``True``
		- fixed_len: ``2``
	...
	* ``particle_property_list``:  *<optional>*
		...
		- default list item: ``None``
		- self: ``<oceantracker.util.parameter_checking.ParameterListChecker object at 0x0000029B1D0143A0>``
		- can_be_empty_list: ``True``
