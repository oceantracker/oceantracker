...
**Doc:**     Calculates the 2D vector magnitude, ignores vert component of vector in calculating magnitude    

**short class_name:** VectorMagnitude2D

**full class_name :** oceantracker.particle_properties.vector_magnitude.VectorMagnitude2D
...
**Inheritance:** > ParameterBaseClass> _BaseParticleProperty> CustomParticleProperty> VectorMagnitude2D
...
************
	...
	* ``vector_part_prop`` :   ``<class 'str'>`` **<isrequired>**
		Description: name of vector particle property to calculate magnitude of, eg wind_stress
