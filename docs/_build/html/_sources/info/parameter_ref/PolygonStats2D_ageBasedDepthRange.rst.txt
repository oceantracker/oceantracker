...
************
	...
	* ``grid_size``:  *<optional>*
		...
		- default list item: ``None``
		- self: ``<oceantracker.util.parameter_checking.ParameterListChecker object at 0x000001E0125B0580>``
		- can_be_empty_list: ``True``
		- fixed_len: ``2``
	...
	* ``grid_span``:  *<optional>*
		- a list containing type:  ``<class 'float'>``
		- default list item: ``None``
		- self: ``<oceantracker.util.parameter_checking.ParameterListChecker object at 0x000001E0125A4850>``
		- can_be_empty_list: ``True``
		- fixed_len: ``2``
	...
	* ``particle_property_list``:  *<optional>*
		...
		- default list item: ``None``
		- self: ``<oceantracker.util.parameter_checking.ParameterListChecker object at 0x000001E0125A41C0>``
		- can_be_empty_list: ``True``
